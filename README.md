...
- **Blog Management**: Full CRUD operations for creating, editing, and deleting articles  
- **Real-time Comments**: Comment system on articles with live updates  
- **Live Presence**: See which users are currently viewing the same article  
- **Modern UI**: Clean and responsive interface built with shadcn/ui components  
- **Real-time Sync**: All interactions updated instantly using Convex  
