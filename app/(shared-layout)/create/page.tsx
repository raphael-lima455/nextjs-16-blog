    ...
    return (
        <div className="py-12 ">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-muted-foreground pt-4">Create you own blog article...</p>
            </div>
                            ...
                            <Controller
                                ...
                                render={({ field, fieldState }) => (
                                    <Field>
                                        ...
                                        <Input aria-invalid={fieldState.invalid} placeholder="Super cool title..." type="file" accept="image/*" onChange={(event) => {
